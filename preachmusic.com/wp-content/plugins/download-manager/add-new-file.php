...
<h2><?php echo __('Edit Download Package','wpdmpro'); ?> <input id="vp" style="display: none;" type="button" class="button-secondary" value="View Package"></h2>
<?php } else { ?>
    <div class="icon32" id="icon-add-new-file"><br></div>
...
<a base="<?php echo home_url('/'.get_option('__wpdm_purl_base','download').'/');  ?>" href="<?php echo home_url('/'.get_option('__wpdm_purl_base','download').'/'.get_wpdm_meta($file['id'],'url_key'));  ?>/" target="_blank" class="button" id="wview" style="font-weight:200;margin-left: 15px;margin-top: 5px;font-style: italic;"> View Package</a>
</td>
</tr>
...
<td style="width: 40%;"><input style="width:99%" type="text" name='wpdm_meta[fileinfo][<?php echo $value; ?>][title]' value="<?php echo $fileinfo[$value]['title'];?>"></td>
...
<table  width="100%" cellpadding="0" cellspacing="0">
<?php if(get_option('_wpdm_facebook_app_id')=='') echo "<tr><td colspan=2>You have a add a Facebook appID <a href='admin.php?page=file-manager/settings#fbappid'>here</a></td></tr>"; ?>
<tr>
...
<a onclick="return false;" id="img" class="thickbox" href="#">
...
<script type="text/javascript">
      ...
      jQuery(document).ready(function() {
        ...
        jQuery('#rmvp').live('click',function(){
            ...
            jQuery(this).fadeOut();
            jQuery('#img').html('<img src="<?php echo plugins_url("/download-manager/images/add-image.gif"); ?>\" /> Add Main Preview Image');
            return false;
        });
