...
function wpdm_odir_tree(){
    if($_GET['task']!='wpdm_odir_tree') return;
...
function wpdm_dir_browser(){
    if($_GET['task']!='wpdm_dir_browser') return;
    ?>                                                         
...
function wpmp_dir_browser_metabox(){
    ?>
    
    <div class="postbox " id="daction">
<div title="Click to toggle" class="handlediv"><br></div><h3 class="hndle"><span><?php echo __('Add dir from server','wpdmpro'); ?></span></h3>
<div class="inside">
<input style="width: 98%" type="text" id="srvdir" value="<?php echo get_wpdm_meta((int)$_GET['id'],'package_dir'); ?>" name="wpdm_meta[package_dir]" /> <Br/>

  <br>

<a href="admin.php?page=file-manager&task=wpdm_dir_browser" class="thickbox button-secondary"><?php echo __('Open Dir Browser','wpdmpro'); ?></a>
