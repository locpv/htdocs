...
<?php } ?>
            <p class="login-username"> 
                ...
                <input type="text" name="login[log]" id="user_login" class="input required text" value="" size="20" tabindex="38" /> 
            </p> 
            <p class="login-password"> 
                <label for="user_pass">Password</label> 
                <input type="password" name="login[pwd]" id="user_pass" class="input required password" value="" size="20" tabindex="39" /> 
            </p> 
            
            <p class="login-remember"><label><input name="rememberme" type="checkbox" id="rememberme" value="forever" tabindex="39" /> Remember Me</label></p> 
...
<input type="hidden" name="minimaxtask" value="remindpass" />
    ...
    <p>
        ...
        <input type="text" tabindex="41" size="20" value="" class="input required email" id="user_login" name="user_login"> <input type="submit" tabindex="42" value="Remind Me!" class="btn btn-blue" id="wp-submit" name="wp-submit">
