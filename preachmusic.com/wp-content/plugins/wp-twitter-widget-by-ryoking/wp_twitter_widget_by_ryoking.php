...
?>
        ...
        <br />
        <input class="checkbox" type="checkbox" <?php echo $showdesc; ?> id="<?php echo $this->get_field_id('showdesc'); ?>" name="<?php echo $this->get_field_name('showdesc'); ?>" value="1"/> 
        <label for="<?php echo $this->get_field_id('showdesc'); ?>"><?php _e('Show User Description'); ?></label>
