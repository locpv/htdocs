<div id="ti-media" class="ti-metabox">
	  	...
	  	<table>
	  		<tr>
	  			<td scope="row" colspan="2">
	  				<label><strong><?php echo __( 'Media Source URL', 'theme-it' ); ?></strong></label>
	  	...
	  	<table>
	  		...
	  		<tr>
	  			<td>
	  				...
	  				<p><?php echo __( 'To use this option, simply copy and past the URL of media content from an ', 'theme-it' ) . '<a href="http://codex.wordpress.org/Embeds#Okay.2C_So_What_Sites_Can_I_Embed_From.3F" target="_blank">' . __( 'approved site', 'theme-it' ) . '</a>' . __( '(e.g. vimeo.com). ', 'theme-it' ); ?></p>
	  			</td>
	  		</tr>
	  		<tr>
	  			<td>
	...
	<?php if( $mb->get_the_value( 'media_source' ) || $mb->get_the_value( 'media_embed_code' ) ) : ?>
	  <div class="ti-embed-preview" style="padding-top: 8px">
	  		<?php do_action( 'get_media', get_the_ID(), 258, 258, false ); ?>
	  </div>
	<?php endif; ?>
